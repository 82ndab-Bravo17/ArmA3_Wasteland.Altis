...
A3W_moneyMissionTimeout = (60*60);    // Time in seconds that a Main Mission will run for, unless completed
A3W_moneyMissionDelayTime = (2*60);// Time in seconds between Main Missions, once one is over
